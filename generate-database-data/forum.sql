-- Forum Posts
INSERT INTO Forum (Title, Description, ForumCategory, UserID, IsPinned, LikesCount, Timestamp)
...
-- Comments for ForumID 1 (Company Policy Update)
INSERT INTO ForumComments (ForumID, UserID, Comment, Timestamp)
...
-- Comments for ForumID 2 (Office Birthday Celebrations)
INSERT INTO ForumComments (ForumID, UserID, Comment, Timestamp)
VALUES (2, 33, 'This sounds exciting! I have a few ideas for the celebration.', '2025-03-12 10:30:00');

-- Comments for ForumID 3 (Network Downtime Notice)
INSERT INTO ForumComments (ForumID, UserID, Comment, Timestamp)
