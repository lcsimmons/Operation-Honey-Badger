...
export default function Reports() {
	...
	const fetchReportsFromBackend = async () => {
	  try {
		const res = await fetch('https://cs412anallam.me:5000/api/reports');
                            ...
                            <div>
                                <button
                                    onClick={async () => {
                                        ...
                                        try {
                                            const res = await fetch("https://cs412anallam.me:5000/api/generate_narrative_report?attacker_id=" + attackerIdInput);
