    ...
    return (
        <div className="min-h-screen bg-white text-gray-800 p-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mt-8">
                ...
                <AdminCard href="/admin/expenses" icon={<FileText />} title="Expenses" desc="View reimbursement logs." />
                <AdminCard href="/admin/it-support" icon={<LifeBuoy />} title="IT Support" desc="Ticket queue." />
                <AdminCard href="/admin/performance" icon={<BarChart2 />} title="Performance" desc="View key performance indicators." />
                <AdminCard href="/admin/corporate" icon={<Building />} title="Corporate Projects" desc="Monitor initiatives." />
